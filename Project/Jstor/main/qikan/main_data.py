...
class SpiderMain(BastSpiderMain):
    ...
    # 模板
    def template(self, save_data, select, url, sha):
        ...
        # 获取作者
        save_data['zhaiYao'] = self.server.getZhaiYao(select)
        ...
        # 获取出版社
        save_data['huBanShe'] = self.server.getChuBanShe(select)
        print(save_data['huBanShe'])
    ...
    def handle(self, task, save_data):
        ...
        # 获取字段值
        self.template(save_data=save_data, select=selector, url=url, sha=sha)
