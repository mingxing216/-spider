...
class SpiderMain(BastSpiderMain):
    ...
    def handle(self, task_data):
        ...
        task = ast.literal_eval(task_data)
        # print(task)
        ...
        if status is False:
            ...
            # 获取论文主页html源码
            url = 'http://kns.cnki.net/kcms/detail/detail.aspx?sfield=FN&dbCode=CMFD&fileName=2007096918.nh&tableName=CMFD2007'
            ...
            if article_html['status'] == 0:
                ...
                # 保存数据
                self.dao.saveDataToHbase(data=task)
    ...
    def start(self):
        while True:
            ...
            task_list = self.dao.getTask(key=config.REDIS_XUEWEILUNWEN_LUNWEN, count=100,
