...
# 期刊论文_论文数据
QIKANLUNWEN_LUNWENDATA_PROCESS_NUMBER = 1
# 会议论文_论文数据
HUIYILUNWEN_LUNWENDATA_PROCESS_NUMBER = 1
# 学位论文_论文数据
XUEWEILUNWEN_LUNWENDATA_PROCESS_NUMBER = 1

# 知网论文_机构数据
ZHIWANGLUNWEN_JIGOUDATA_PROCESS_NUMBER = 1
# 知网论文_作者数据
ZHIWANGLUNWEN_ZUOZHEDATA_PROCESS_NUMBER = 1
# 知网论文_会议数据
