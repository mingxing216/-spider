...
MYSQL_PAPER = 'job_journal_paper' # Mysql论文任务表
...
REDIS_ZHEXUESHEHUIKEXUE_TEST = 'zhexueshehuikexue_test' # Redis论文任务表
REDIS_ZHEXUESHEHUIKEXUE_TEST_LOCK = 'zhexueshehuikexue_test_lock' # Redis论文分布式锁名

# MYSQL_TEST = 'job_paper_temp' # Mysql论文任务表
# REDIS_ZHEXUESHEHUIKEXUE_TEST = 'zirankexue_paper_temp' # Redis论文任务表
# REDIS_ZHEXUESHEHUIKEXUE_TEST_LOCK = 'zirankexue_paper_temp_lock' # Redis论文分布式锁名
