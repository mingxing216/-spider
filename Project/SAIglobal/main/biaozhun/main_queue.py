...
LOGNAME = 'SAIglobal_标准_queue'  # LOG名
NAME = 'SAIglobal_标准_queue'  # 爬虫名
    ...
    def start(self):
        while 1:
            ...
            if url_number == 0:
                ...
                # 获取任务
                new_task_list = self.dao.getNewTaskList(table=config.MYSQL_STANTARD, ws='SAI GLOBAL', es='标准', count=2000)
                # print(new_task_list)
                # 队列任务
