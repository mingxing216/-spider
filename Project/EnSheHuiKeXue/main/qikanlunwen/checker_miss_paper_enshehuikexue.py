...
class CheckerMain(BaseChecher):
    ...
    def handle(self, task_list, data_list):
        ...
        doc_data_list = self.hbase_obj.get_datas_from_hbase('ss_document', doc_sha_list, doc_columns)
    ...
    def run(self):
        ...
        query = "SingleColumnValueFilter('s', 'ws', =, 'substring:哲学社会科学外文OA资源数据库') AND SingleColumnValueFilter('d', 'metadata_version', =, 'substring:V1', true, true)"
        ...
        with open('/opt/Log/Temp/ensheke_miss_sha.log', 'r') as f:
