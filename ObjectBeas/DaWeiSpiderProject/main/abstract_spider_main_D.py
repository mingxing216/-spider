...
class SpiderMain(object):
    def __init__(self):
        ...
        self.innojoy_page_guid = 'innojoy_page_guid_D'  # redis中保存下一页guid的建
        self.innojoy_page_number = 'innojoy_page_number_D'  # redis中保存当前在抓页数的建
        self.innojoy_region_number = 'innojoy_region_number_D'  # redis中保存当前专利地区分类索引的建
        self.innojoy_sic_number = 'innojoy_sic_number_D'  # redis中保存专利分类索引的建
