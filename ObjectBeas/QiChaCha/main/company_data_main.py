...
from ObjectBeas.QiChaCha.dao import dao
from ObjectBeas.QiChaCha.middleware import download_middleware
from ObjectBeas.QiChaCha.services import services
...
if __name__ == '__main__':
    cookie = 'null'
    user_agent = user_agent_u.get_ua()
